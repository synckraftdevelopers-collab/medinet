...
export default function PrivacyPolicyPage() {
  ...
  return (
    <LegalLayout
      ...
      sections={sections}
    >
      <LegalSection id="information-collection" title="1. Information Collection" icon="Database" index={0}>
      ...
      <LegalSection id="use-of-data" title="2. Use of Corporate Data" icon="Building2" index={1}>
      ...
      <LegalSection id="data-security" title="3. Data Security & Compliance" icon="ShieldCheck" index={2}>
      ...
      <LegalSection id="third-party" title="4. Third-Party Sharing" icon="Handshake" index={3}>
      ...
      <LegalSection id="your-rights" title="5. Your Privacy Rights" icon="BadgeCheck" index={4}>
