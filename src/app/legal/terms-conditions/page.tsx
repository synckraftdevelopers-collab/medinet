  ...
  return (
    ...
    >
      ...
      <section id="medical-disclaimer">
        <h2 className="text-xl font-bold text-slate-900 mb-3 mt-6">2. No Medical Advice</h2>
      ...
      <section id="intellectual-property">
        <h2 className="text-xl font-bold text-slate-900 mb-3 mt-6">3. Intellectual Property</h2>
      ...
      <section id="limitation">
        <h2 className="text-xl font-bold text-slate-900 mb-3 mt-6">4. Limitation of Liability</h2>
      ...
      <section id="jurisdiction">
        <h2 className="text-xl font-bold text-slate-900 mb-3 mt-6">5. Governing Law</h2>
