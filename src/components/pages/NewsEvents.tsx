        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="lg:w-1/3 lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl font-display font-bold text-primary mb-4">Product Launches</h2>
          ...
          <div className="flex flex-col lg:flex-row-reverse gap-12 items-start">
            <div className="lg:w-1/3 lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl font-display font-bold text-primary mb-4">Medical Conferences</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            <div className="lg:w-1/3 lg:sticky lg:top-32">
              ...
              <h2 className="text-3xl font-display font-bold text-primary mb-4">Company Announcements</h2>
